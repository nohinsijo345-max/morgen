...
const BuyerProfileRequests = () => {
  ...
  const fetchRequests = async () => {
    try {
      ...
      // Filter only buyer requests
      const buyerRequests = response.data.filter(request => 
      ...
      setError('Failed to load buyer profile change requests');
    } finally {
      setLoading(false);
    }
  };
    ...
    <AdminBuyerLayout currentPage="profile-requests">
      <div className="p-6">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-3xl font-bold text-[#FF4757] mb-2">Buyer Profile Change Requests</h1>
          <p className="text-[#FF6B7A]">Review and approve buyer profile update requests</p>
        </motion.div>
      ...
      {requests.length === 0 ? (
        <AdminGlassCard className="text-center py-12">
          ...
          <h3 className="text-xl font-bold mb-2" style={{ color: colors.textPrimary }}>No Pending Buyer Requests</h3>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900">Reject Buyer Request</h3>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                placeholder="Please provide a reason for rejecting this buyer request..."
