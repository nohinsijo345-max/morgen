...
const AdminBuyerLayout = ({ children, currentPage = 'dashboard', onLogout, onBack }) => {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-bold" style={{ color: colors.textPrimary }}>Buyer Admin</h1>
                  ...
                  return (
                    <motion.button
                      ...
                      style={{
                        ...
                        boxShadow: isActive ? '0 4px 15px rgba(236, 72, 153, 0.4)' : 'none'
                      }}
                      onMouseEnter={(e) => {
                        if (!isActive) {
