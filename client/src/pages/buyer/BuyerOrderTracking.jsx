...
const BuyerOrderTracking = () => {
  ...
  const fetchBuyerBookings = async () => {
    try {
      ...
      console.log('🔍 BuyerOrderTracking - Current user data:', userData);
      ...
      console.log('🔍 BuyerOrderTracking - Fetching bookings for buyer phone:', userData.phone);
      
      const response = await axios.get(`${API_URL}/api/transport/bookings/buyer/phone/${userData.phone}`);
      console.log('🔍 BuyerOrderTracking - Bookings response:', response.data);
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold" style={{ color: colors.textPrimary }}>Order Tracking</h1>
